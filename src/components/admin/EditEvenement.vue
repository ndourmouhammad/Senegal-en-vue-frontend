<template>
          ...
          <form @submit.prevent="submitForm" class="mt-5">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <select v-model="evenement.site_touristique_id" class="form-control" id="region_id">
            ...
            <div class="mb-3">
              ...
              <select v-model="evenement.category_id" class="form-control" id="category_id">
            ...
            <div class="mb-3">
              ...
              />
              <p v-if="evenement.image" class="mt-2">Fichier existant : </p>

    <div v-if="evenement.image">
        <template v-if="isVideo(evenement.image)">
            <video controls :src="getMediaUrl(evenement.image)" class="mt-2" style="max-width: 50px; height: 50px"></video>
        </template>
        <template v-else>
            <img :src="getMediaUrl(evenement.image)" alt="Image existante" class="mt-2" style="max-width: 50px; height: 50px" />
        </template>
    </div>
            </div>
  ...
  onMounted(async () => {
    try {
      ...
      const evenementData = await evenementService.getEvenementDetails(evenementId)
  ...
  const submitForm = async () => {
    ...
    if (evenement.value.image instanceof File) {
        ...
        console.log("Aucun nouveau fichier sélectionné, en gardant le fichier existant : ", evenement.value.image);
    } else {
