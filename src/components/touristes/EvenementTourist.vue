<template>
        ...
        <div class="row mt-4">
          ...
          <div class="col-md-3">
            <div class="filter-sidebar">
              ...
              <form>
                ...
                <button type="submit" class="btn btn-light rounded-pill px-3 mt-2 btn-filter" style="background-color: #3498DB; color: #fff">Filtrer</button>
              </form>
            </div>
          </div>
          ...
          <div class="col-md-9">
            <div class="row">
              ...
              <div class="col-md-4 mb-4" v-for="evenement in evenements" :key="evenement.id">
                <div class="card mb-4">
                  <img :src="evenement.image" class="card-img-top" alt="Event Image" />
                  <span class="activity-badge">{{ evenement.activity }}</span>
                  <div class="card-body">
                    <h5 class="card-title">{{ evenement.name }}</h5>
                    <p class="card-text">{{ evenement.description }}</p>
                    <div class="d-flex justify-content-between">
                      <button class="badge ">{{ evenement.places }} places</button>
                      <a href="#" class="badge ">Voir Détails</a>
                    </div>
                  </div>
                </div>
              </div>
  ...
  const evenements = ref([
    ...
    },
    {
      id: 2,
      name: 'Événement 2',
      description: 'ParagrapheParagrapheParagrapheParagrapheParagrapheParagrapheParagrapheParagrapheParagrapheParagrapheParagrapheParagraphe',
      places: 30,
      image: 'https://via.placeholder.com/150',
      activity: 'Activité 2'
    },
